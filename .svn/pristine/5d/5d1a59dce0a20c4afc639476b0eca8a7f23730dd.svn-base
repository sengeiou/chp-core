...
import com.creditharmony.core.mybatis.paginator.dialect.Dialect;
import com.creditharmony.core.mybatis.paginator.domain.PageBounds;
import com.creditharmony.core.mybatis.paginator.domain.PageList;
import com.creditharmony.core.mybatis.paginator.domain.Paginator;
import com.creditharmony.core.mybatis.paginator.support.PropertiesHelper;
import com.creditharmony.core.mybatis.paginator.support.SQLHelp;


/**
 * 为MyBatis提供基于方言(Dialect)的分页查询的插件
 * 将拦截Executor.query()方法实现分页方言的插入.
 * @Class Name OffsetLimitInterceptor
 * @author 张永生
