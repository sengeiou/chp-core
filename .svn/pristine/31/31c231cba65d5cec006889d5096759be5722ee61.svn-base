...
/**
 * 三网用户的历史对象
 * 即：从系统管理模块同步用户到业务模块的历史记录:财富
 * @Class Name ThreeNetUserHistory
 * @author 张永生
 * @Create In 2016年2月29日
 */
public class ThreeNetUserHistory extends DataEntity<ThreeNetUserHistory> {

	private static final long serialVersionUID = 898060144276425395L;
	private String syncUserId;             		// 同步用户实体Id
	...
	protected String status;					// 状态:1-允许登录;0-不允许登录
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((syncUserId == null) ? 0 : syncUserId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ThreeNetUserHistory other = (ThreeNetUserHistory) obj;
		...
		if (syncType == null) {
			...
			return false;
		if (syncUserId == null) {
			if (other.syncUserId != null)
				return false;
		} else if (!syncUserId.equals(other.syncUserId))
			return false;
		if (teamId == null) {
