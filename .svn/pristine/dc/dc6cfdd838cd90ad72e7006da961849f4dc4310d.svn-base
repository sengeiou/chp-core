package com.creditharmony.core.supcan.web;
...
import com.creditharmony.core.supcan.treelist.TreeList;
import com.creditharmony.core.supcan.treelist.annotation.SupTreeList;
import com.creditharmony.core.supcan.treelist.cols.Col;
import com.creditharmony.core.supcan.treelist.cols.Group;
import com.creditharmony.core.supcan.treelist.cols.annotation.SupCol;
import com.creditharmony.core.supcan.treelist.cols.annotation.SupGroup;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeListTest() {
		...
		groupCol.add(new Col("createTime", "创建时间"));
		groupCol.add(new Col("modifyTime", "更新时间"));
		
		// 分组2
		Group group2 = new Group("时间2");
		List<Object> group2Col = group2.getCols();
		group2Col.add(new Col("createTime2", "创建时间2"));
		group2Col.add(new Col("modifyTime2", "更新时间2"));
