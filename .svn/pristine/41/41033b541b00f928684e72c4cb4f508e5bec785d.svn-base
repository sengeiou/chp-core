...
/**
 * 自定义的表单验证（包含验证码）过滤类
 * @Class Name CustomFormAuthenticationFilter
 * @author 张永生
 * @Create In 2015年12月19日
 */
@Service
public class CustomFormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
