...
public class CtlrAspectProcessComm {
//	private final Logger logger = LoggerFactory.getLogger(getClass());
//	private final String strCname = this.getClass().getName();
	private String strFlg;
	private CtlrAspectProcessComm(){}
	
	public CtlrAspectProcessComm(String strFlg){
				...
				for(; i<intLength; i++){
					...
					if(obj!=null){
						...
						if(strArgClassName!=null && strArgClassName.trim().length()>0
							...
							AopobjProcessComm objAp = new AopobjProcessComm(reqObj, userObj, methodName);
