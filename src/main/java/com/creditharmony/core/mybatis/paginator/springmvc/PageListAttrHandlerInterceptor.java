package com.creditharmony.core.mybatis.paginator.springmvc;
...
/**
 * 将ServletRequest和ModelAndView里包含PageList的Paginator取出
 * 并建立名为原属性名+Paginator后缀的属性
 * @Class Name PageListAttrHandlerInterceptor
 * @author 张永生
