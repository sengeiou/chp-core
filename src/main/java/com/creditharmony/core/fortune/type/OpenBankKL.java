...
public enum OpenBankKL {
	...
	GFYH("306", "广东发展银行", "广发银行"),
	PAYH("307", "平安银行股份有限公司", "平安银行"),
	ZSYH("308", "招商银行", "招商银行"),
	XYYH("309", "兴业银行", "兴业银行总行"),
	SHPDFZYH("310", "上海浦东发展银行", "上海浦东发展银行"),
	ZGYZCXYH("403", "中国邮政储蓄银行有限责任公司", "中国邮政储蓄银行总行"),
	JTYH("666", "交通银行", "交通银行");
	...
	private OpenBankKL (String bankKey, String bankNameDef, String bankNameKL) {
	...
	public static String getOpenBank(String value) {
		...
		for (OpenBankKL bank : OpenBankKL.values()) {
