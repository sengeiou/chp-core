...
public class CmsUtils {
	...
	private static CategoryManager categoryManager = SpringContextHolder.getBean(CategoryManager.class);
	private static ArticleManager articleManager = SpringContextHolder.getBean(ArticleManager.class);
	...
	public static List<Category> getMainNavList(String siteId){
		...
		page = categoryManager.find(page, category);
		List<Category> mainNavList = page.getList();
		return mainNavList;
	}
	/**
	 * 获取栏目
	...
	public static List<Category> getCategoryListByIds(String categoryIds){
		return categoryManager.findByIds(categoryIds);
	}
	...
	public static Article getArticle(String articleId){
		return articleManager.get(articleId);
	}
	...
	public static List<Link> getLinkList(String siteId, String categoryId, int number, String param){
		...
		page = linkManager.findPage(page, link, false);
		return page.getList();
	}
    ...
    public static void addViewPolicyConfigAttribute(Model model, CategoryPolicy categoryPolicy){
        ...
        Collections.reverse(categoryList);
        for(CategoryPolicy ca : categoryList){
        	addViewConfigAttribute(model, ca.getViewConfig());
        }
    }
}