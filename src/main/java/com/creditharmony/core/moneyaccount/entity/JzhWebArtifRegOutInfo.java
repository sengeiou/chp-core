...
/**
 * 法人用户自助开户注册（网页版）响应参数Bean.
 * @Class Name JzhWebArtifRegOutInfo
 * @author CHP_3.0 接口组
 * @Create In 2016年2月22日
 */
public class JzhWebArtifRegOutInfo extends BaseInfo implements IParamInfo{
	/** 响应码. */
